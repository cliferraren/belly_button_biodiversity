...
# Dependencies - Flask Micro Framework
from flask import Flask, jsonify, render_template, request, flash, redirect

# Dependencies - SQL Alchemy (ORM)
import sqlalchemy
from sqlalchemy.ext.automap import automap_base
from sqlalchemy.orm import Session
from sqlalchemy import create_engine, func, desc,select

# Dependencies - Python Pandas and Numpy
import pandas as pd
import numpy as np


# Creates an Engine, which is used to deliver SQL statements to the SQLite database
...
#Session is the primary interface for persistence operations in the SQLAlchemy ORM
session = Session(engine)


# Flask Setup - this is a flask application
app = Flask(__name__)


# Flask appp work in routes
...
# Page that will return list of bacteria names
@app.route('/names')
def names():
